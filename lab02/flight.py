...
if __name__ == '__main__':
    ...
    drone_client.move(0.2, 0.0, 0.5, 0.0, 6.0)  # move 0.2 meters forward
    drone_client.move(0.2, 0.2, 0.5, 0.0, 6.0)  # move 0.2 meters left
    drone_client.move(0.0, 0.2, 0.5, 0.0, 6.0)  # move 0.2 meters back
    drone_client.move(0.0, 0.2, 0.5, 0.0, 6.0)  # move 0.2 meters back
    drone_client.move(0.0, 0.0, 0.5, 0.0, 6.0)  # move 0.2 meters right
    drone_client.move(0.0, 0.0, 0.1, 0.0, 3.0)  # prepare for landing from a height of 0.1 meters
    ...
    with open('square2.json', 'w') as outfile:
